...
public class Empresa {
    ...
    public String toString() {
        return "Empresa{" + "id=" + id + ", cnpj=" + cnpj + ", razaoSocial=" + razaoSocial + ", ruaEmpresa=" + ruaEmpresa + ", numeroEmpresa=" + numeroEmpresa + ", complementoEmpresa=" + complementoEmpresa + ", telfoneEmpresa=" + telfoneEmpresa + ", emailEmpresa=" + emailEmpresa + '}';
    }
